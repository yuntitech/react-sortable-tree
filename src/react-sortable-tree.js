...
class ReactSortableTree extends Component {
  ...
  renderRow(
    ...
    return ( <
      ...
      <
      NodeContentRenderer parentNode = {
        parentNode
      }
      isSearchMatch = {
        isSearchMatch
  ...
  render() {
    ...
    return ( <
      div className = {
        classnames('rst__tree', className, rowDirectionClass)
      }
      style = {
        containerStyle
      } >
...
export {
  ReactSortableTree as SortableTreeWithoutDndContext
};
